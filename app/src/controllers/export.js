...
module.exports = class Exports {
	...
	static async exportToPDF (req, res, next) {
		try {
            ...
            // Creates a new PDF document stream using PDFKit. 
            ...
            .on('end', () => {
                ...
                res
                // Required HTTP headers in order for this to be downloaded by clients in their browsers.
            ...
            // Retrieves all currently stored entries - will be used to calculate statistics. 
