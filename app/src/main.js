...
const express = require('express'),
  ...
  swaggerOptions = {
    definition : {
      ...
      info : {
        title : "CyBan API",
        version : "1.1",
        description : "Autogenerated Swagger UI Documentation for CyBan\'s API.",
        license : {
          name : "MIT License",
  ...
  swaggerSpecification = swaggerJsDoc(swaggerOptions, { explorer : true }),
